...
<div id="NameNotDupAlert" class="alert alert-success alert-dismissible fade show p-3 m-0 mt-2" role="alert">
    <div class="row">
        ...
        <div class="col p-0 me-4" style="display: inline-block; text-align: right">
            <i id="name-close" class="fa-solid fa-xmark fa-lg cursor"></i>
        </div>
    </div>
</div>


<div id="NameDupAlert" class="alert alert-danger alert-dismissible fade show p-3 m-0 mt-2" role="alert">
    <div class="row">
        <div class="col p-0" style="display: inline-block; text-align: center;">
